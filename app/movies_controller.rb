...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.where("release_date > 2002", 2002).order(release_date: :desc)
end

def can_be_found_updated_and_saved
  # Updtate the title "Awesome Flick" to "Even Awesomer Flick", save it, then return it
  Movie.create(title: "Awesome Flick")
  awesomer_flick = Movie.find_by(:title => "Awesome Flick")
  awesomer_flick.title = "Even Awesomer Flick"
  awesomer_flick.save
  awesomer_flick
end
...
def can_update_using_update_method
  ...
  wat_huh = Movie.find_by(title: "Wat?")
  wat_huh.update(title: "Wat, huh?")
end
